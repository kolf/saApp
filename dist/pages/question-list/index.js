(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pages/question-list/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/question-list/index.jsx?taro&type=script&parse=PAGE&":
/*!*********************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/question-list/index.jsx?taro&type=script&parse=PAGE& ***!
  \*********************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.scss */ "./src/pages/question-list/index.scss");
...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__445", "$compid__446", "listData", "isFetching"], _this.config = {
      navigationBarTitleText: "人工解答"
    }, _this.state = {
      isFetching: false,
      listData: []
    }, _this.loadData = function () {
      _this.setState({ isFetching: true, listData: [] });
      (0, _apis.getMessageBoardList)().then(function (res) {
        try {
          _this.setState({
            isFetching: false,
            listData: res.data
    ...
    }, _this.customComponents = ["EmptyData", "AtButton"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      _taroWeapp.propsManager.set({
        "type": "primary",
        "onClick": _index.goTo.bind(this, "question-post")
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = [], _class.$$componentPath = "pages/question-list/index", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:\\Users\\kolf\\test\\saApp\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/question-list/index.jsx?taro&type=template&parse=PAGE&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:/Users/kolf/test/saApp/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/question-list/index.jsx?taro&type=template&parse=PAGE& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "pages/question-list/index.wxml";
...
/* harmony import */ var _index_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.jsx?taro&type=template&parse=PAGE& */ "./src/pages/question-list/index.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _index_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.jsx?taro&type=script&parse=PAGE& */ "./src/pages/question-list/index.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pages/question-list/index.jsx?taro&type=script&parse=PAGE&":
/*!************************************************************************!*\
  !*** ./src/pages/question-list/index.jsx?taro&type=script&parse=PAGE& ***!
  \************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/question-list/index.jsx?taro&type=template&parse=PAGE&":
/*!**************************************************************************!*\
  !*** ./src/pages/question-list/index.jsx?taro&type=template&parse=PAGE& ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/question-list/index.scss":
/*!********************************************!*\
  !*** ./src/pages/question-list/index.scss ***!
  \********************************************/
/*! no static exports found */
...
},[["./src/pages/question-list/index.jsx","runtime","vendors","common"]]]);