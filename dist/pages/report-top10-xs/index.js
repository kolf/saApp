(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pages/report-top10-xs/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/report-top10-xs/index.jsx?taro&type=script&parse=PAGE&":
/*!***********************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/report-top10-xs/index.jsx?taro&type=script&parse=PAGE& ***!
  \***********************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.scss */ "./src/pages/report-top10-xs/index.scss");
...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp2", "anonymousState__temp3", "$compid__441", "$compid__442", "$compid__443", "anonymousState__temp", "activeKey", "showType", "data", "zheData", "zhuData", "isFetching", "endDate"], _this.config = {
      ...
      if (showType === 0) {
        return (0, _apis.getxsTopTotal)(_this.makeParams());
      } else if (showType === 1) {
        return (0, _apis.getxsTrend)(_this.makeParams());
      }
  ...
  _createClass(Index, [{
    ...
    value: function _createMainData(_$uid) {
      ...
      return function () {
        var _genCompid = (0, _taroWeapp.genCompid)(_$uid + "$compid__438"),
            _genCompid2 = _slicedToArray(_genCompid, 2),
            $prevCompid__438 = _genCompid2[0],
            $compid__438 = _genCompid2[1];

        var _genCompid3 = (0, _taroWeapp.genCompid)(_$uid + "$compid__439"),
            _genCompid4 = _slicedToArray(_genCompid3, 2),
            $prevCompid__439 = _genCompid4[0],
            $compid__439 = _genCompid4[1];

        var _genCompid5 = (0, _taroWeapp.genCompid)(_$uid + "$compid__440"),
            _genCompid6 = _slicedToArray(_genCompid5, 2),
            $prevCompid__440 = _genCompid6[0],
            $compid__440 = _genCompid6[1];

        var $anonymousCallee__27 = void 0;
        var $anonymousCallee__25 = void 0;

        var _state = _this2.state,
            showType = _state.showType,
            data = _state.data,
            isFetching = _state.isFetching,
            zheData = _state.zheData;
        ...
        if (showType === 0) {
          $anonymousCallee__25 = data ? _this2.makeTendencyTableData(data) : [];
          _taroWeapp.propsManager.set({
            "onCanvasInit": _this2.drawDatass
          }, $compid__439, $prevCompid__439);
        } else if (showType === 1) {
          $anonymousCallee__27 = _this2.makeStatisticalTableData(data);
          _taroWeapp.propsManager.set({
    ...
    value: function _createData() {
      ...
      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__441"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__441 = _genCompid8[0],
          $compid__441 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__442"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__442 = _genCompid10[0],
          $compid__442 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__443"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__443 = _genCompid12[0],
          $compid__443 = _genCompid12[1];
      ...
      var anonymousState__temp = this._createMainData(__prefix + "edzzzzzzzz")();

      var anonymousState__temp2 = ["销售完成台数", "销售完成台数趋势"];
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = [], _class.$$componentPath = "pages/report-top10-xs/index", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:\\Users\\kolf\\test\\saApp\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/report-top10-xs/index.jsx?taro&type=template&parse=PAGE&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:/Users/kolf/test/saApp/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/report-top10-xs/index.jsx?taro&type=template&parse=PAGE& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "pages/report-top10-xs/index.wxml";

/***/ }),

/***/ "./src/pages/report-top10-xs/index.jsx":
/*!*********************************************!*\
  !*** ./src/pages/report-top10-xs/index.jsx ***!
  \*********************************************/
/*! no static exports found */
...
/* harmony import */ var _index_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.jsx?taro&type=template&parse=PAGE& */ "./src/pages/report-top10-xs/index.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _index_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.jsx?taro&type=script&parse=PAGE& */ "./src/pages/report-top10-xs/index.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pages/report-top10-xs/index.jsx?taro&type=script&parse=PAGE&":
/*!**************************************************************************!*\
  !*** ./src/pages/report-top10-xs/index.jsx?taro&type=script&parse=PAGE& ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/report-top10-xs/index.jsx?taro&type=template&parse=PAGE&":
/*!****************************************************************************!*\
  !*** ./src/pages/report-top10-xs/index.jsx?taro&type=template&parse=PAGE& ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/report-top10-xs/index.scss":
/*!**********************************************!*\
  !*** ./src/pages/report-top10-xs/index.scss ***!
  \**********************************************/
/*! no static exports found */
...
},[["./src/pages/report-top10-xs/index.jsx","runtime","vendors","common"]]]);