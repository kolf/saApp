(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pages/select-adviser/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/select-adviser/index.jsx?taro&type=script&parse=PAGE&":
/*!**********************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/select-adviser/index.jsx?taro&type=script&parse=PAGE& ***!
  \**********************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.scss */ "./src/pages/select-adviser/index.scss");
...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__282", "$compid__283", "$compid__284", "listData", "keyword"], _this.config = {
      navigationBarTitleText: "选择顾问"
    }, _this.state = {
      listData: [],
      keyword: ""
    }, _this.loadData = function () {
      var userType = _this.$router.params.userType;

      (0, _apis.getadvisersList)({
        positionName: userType,
        realName: _this.state.keyword
      }).then(function (res) {
        _this.setState({
          listData: _this.markData(res.data)
        });
      });
    }, _this.markData = function (data) {
      if (!data) {
        return [];
      }
      return data.filter(function (item) {
        ...
        return {
          ...
          thumb: item.avatarUrl || _defaultAvatar2.default
        };
      });
    }, _this.handleChange = function (adviserId) {
      _this.setState({
        adviserId: adviserId
      });
      ...
      var _this$state = _this.state,
          ...
          adviserId = _this$state.adviserId;


      _storage2.default.set("orderAdviserData", listData.find(function (o) {
        return o.value === adviserId;
      }));

      _taroWeapp2.default.navigateBack({
        delta: 1 // 返回上一级页面。
      });
    }, _this.customComponents = ["AtSearchBar", "XRadio", "AtButton"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var _state = this.__state,
          ...
          adviserId = _state.adviserId;


      var anonymousState__temp = !adviserId;
      _taroWeapp.propsManager.set({
        "className": "adviser__search-bar"
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = [], _class.$$componentPath = "pages/select-adviser/index", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:\\Users\\kolf\\test\\saApp\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/select-adviser/index.jsx?taro&type=template&parse=PAGE&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:/Users/kolf/test/saApp/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/select-adviser/index.jsx?taro&type=template&parse=PAGE& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "pages/select-adviser/index.wxml";

/***/ }),

/***/ "./src/pages/select-adviser/index.jsx":
/*!********************************************!*\
  !*** ./src/pages/select-adviser/index.jsx ***!
  \********************************************/
/*! no static exports found */
...
/* harmony import */ var _index_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.jsx?taro&type=template&parse=PAGE& */ "./src/pages/select-adviser/index.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _index_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.jsx?taro&type=script&parse=PAGE& */ "./src/pages/select-adviser/index.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pages/select-adviser/index.jsx?taro&type=script&parse=PAGE&":
/*!*************************************************************************!*\
  !*** ./src/pages/select-adviser/index.jsx?taro&type=script&parse=PAGE& ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/select-adviser/index.jsx?taro&type=template&parse=PAGE&":
/*!***************************************************************************!*\
  !*** ./src/pages/select-adviser/index.jsx?taro&type=template&parse=PAGE& ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/select-adviser/index.scss":
/*!*********************************************!*\
  !*** ./src/pages/select-adviser/index.scss ***!
  \*********************************************/
/*! no static exports found */
...
},[["./src/pages/select-adviser/index.jsx","runtime","vendors","common"]]]);