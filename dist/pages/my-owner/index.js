(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pages/my-owner/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/my-owner/index.jsx?taro&type=script&parse=PAGE&":
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/my-owner/index.jsx?taro&type=script&parse=PAGE& ***!
  \****************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.scss */ "./src/pages/my-owner/index.scss");
...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "$compid__267", "$compid__268", "$compid__269", "$compid__270", "$compid__271", "$compid__272", "$compid__273", "isError", "type", "listData", "total", "isFetching", "keyword", "userInfo"], _this.config = {
      ...
      (0, _apis.getCuList)({
        ...
        var _res$data = res.data,
            _res$data$cus = _res$data.cus,
            cus = _res$data$cus === undefined ? [] : _res$data$cus,
            _res$data$newCUCount = _res$data.newCUCount,
            newCUCount = _res$data$newCUCount === undefined ? 0 : _res$data$newCUCount;

        var listData = _this.makeData(cus);
        _this.setState({
          isFetching: false,
          total: cus.length,
          listData: listData,
          newCUCount: newCUCount
        });
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__267"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__267 = _genCompid2[0],
          $compid__267 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__268"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__268 = _genCompid4[0],
          $compid__268 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__269"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__269 = _genCompid6[0],
          $compid__269 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__270"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__270 = _genCompid8[0],
          $compid__270 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__271"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__271 = _genCompid10[0],
          $compid__271 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__272"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__272 = _genCompid12[0],
          $compid__272 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__273"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__273 = _genCompid14[0],
          $compid__273 = _genCompid14[1];
      ...
      var _state = this.__state,
          ...
          newCUCount = _state.newCUCount,
          type = _state.userInfo.type;
      ...
      !isError && type === "FW" && _taroWeapp.propsManager.set({
        "className": "gap-top"
      ...
      !isError && type === "FW" && _taroWeapp.propsManager.set({
        ...
        "onClick": _index.goTo.bind(this, "new-owner")
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = [], _class.$$componentPath = "pages/my-owner/index", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:\\Users\\kolf\\test\\saApp\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/my-owner/index.jsx?taro&type=template&parse=PAGE&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:/Users/kolf/test/saApp/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/my-owner/index.jsx?taro&type=template&parse=PAGE& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "pages/my-owner/index.wxml";

/***/ }),

/***/ "./src/pages/my-owner/index.jsx":
/*!**************************************!*\
  !*** ./src/pages/my-owner/index.jsx ***!
  \**************************************/
/*! no static exports found */
...
/* harmony import */ var _index_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.jsx?taro&type=template&parse=PAGE& */ "./src/pages/my-owner/index.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _index_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.jsx?taro&type=script&parse=PAGE& */ "./src/pages/my-owner/index.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pages/my-owner/index.jsx?taro&type=script&parse=PAGE&":
/*!*******************************************************************!*\
  !*** ./src/pages/my-owner/index.jsx?taro&type=script&parse=PAGE& ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/my-owner/index.jsx?taro&type=template&parse=PAGE&":
/*!*********************************************************************!*\
  !*** ./src/pages/my-owner/index.jsx?taro&type=template&parse=PAGE& ***!
  \*********************************************************************/
/*! no static exports found */
...
},[["./src/pages/my-owner/index.jsx","runtime","vendors","common"]]]);