...
var AtImagePicker = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtImagePicker, [{
    ...
    value: function _createData() {
      ...
      var loopArray73 = matrix.map(function (row, i) {
        row = {
          $original: (0, _taroWeapp.internal_get_original)(row)
        };
        var $loopState__temp3 = i + 1;
        var $anonymousCallee__29 = row.$original.map(function (item, j) {
          item = {
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=C:\\Users\\kolf\\test\\saApp\\node_modules&outputPath=npm!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./node_modules/taro-ui/dist/weapp/components/image-picker/index.tsx?taro&type=template&parse=COMPONENT&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
...
},[["./node_modules/taro-ui/dist/weapp/components/image-picker/index.tsx","runtime","vendors"]]]);