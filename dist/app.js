...
var _App = function (_BaseComponent) {
  ...
  function _App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _App.__proto__ || Object.getPrototypeOf(_App)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      pages: ["pages/index/index", "pages/login/index", "pages/register/index", "pages/profile/index", "pages/review-result/index", "pages/update-name/index", "pages/update-phone/index", "pages/my-owner/index", "pages/new-owner/index", "pages/select-adviser/index", "pages/my-order/index", "pages/my-profile/index", "pages/profile-card/index", "pages/owner-details/index", "pages/order-details/index", "pages/my-integral/index", "pages/integral-details/index", "pages/my-employees/index", "pages/new-employees/index", "pages/employees-details/index", "pages/report/index", "pages/report-success/index", "pages/report-error/index", "pages/report-users/index", "pages/report-users-fw/index", "pages/report-users-esc/index", "pages/report-users-xs/index", "pages/report-top10/index", "pages/all-order/index", "pages/admin-profile/index", "pages/order-list/index", "pages/evaluation-details/index", "pages/all-employees/index", "pages/report-top10-fw/index", "pages/report-top10-er/index", "pages/report-top10-xs/index", "pages/rule-details/index", "pages/shop/index", "pages/integral-rule/index", "pages/question-list/index", "pages/service-index/index", "pages/my-help/index", "pages/question-post/index"],
      window: {
